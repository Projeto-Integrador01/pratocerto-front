...
function CardVegetariano({produto}: CardVegetarianoProps){
    ...
    return (
      ...
      <div className="bg-white rounded-lg overflow-hidden mb-8  w-80 shadow-lg hover:shadow-xl hover:scale-102 transition-all duration-300 mx-auto border-4 border-green-700 flex flex-col">
      {/* Imagem do Produto */}
...
export default CardVegetariano