  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
        ...
        <form
          className="flex justify-center items-center flex-col w-2/3 gap-3 flex-grow"
        ...
        >
          ...
          {/* Espaçamento entre os campos e botões */}
          <div className="flex flex-col w-full mt-auto">
            <div className="flex justify-around w-full gap-8">
              <button
                className="rounded text-white bg-black hover:opacity-80 w-1/2 py-2"
                onClick={retornar}
              >
                Cancelar
              </button>
              <button
                type="submit"
                className="rounded text-white bg-black hover:opacity-75 w-1/2 py-2 flex justify-center"
              >
                {isLoading ? (
                  <RotatingLines
                    strokeColor="white"
