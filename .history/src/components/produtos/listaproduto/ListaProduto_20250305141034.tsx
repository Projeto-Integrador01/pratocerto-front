...
function ListaProduto() {
  ...
  // Função para ser chamada após edição ou exclusão
  ...
  return (
    <>
      ...
      <div className="flex items-center mt-9 mx-25">
        ...
        <ModalProduto atualizarProdutos={atualizarProdutos} /> {/* Passando a função para atualizar após o cadastro */}
      </div>
        ...
        <div className="container flex flex-col mx-2 relative">
          ...
          <div className="container mx-auto my-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {produtos.map((produto) => (
              <CardProdutos key={produto.id} produto={produto} atualizarProdutos={atualizarProdutos} />  {/* Passando a função para atualizar */}
            ))}
          </div>
        </div>
      </div>
