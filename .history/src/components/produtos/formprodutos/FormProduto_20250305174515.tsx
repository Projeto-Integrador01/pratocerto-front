...
function FormProduto() {
    ...
    return (
        <div className="flex w-full h-screen">
            {/* Container do formulário alinhado à esquerda e ocupando 50% da largura */}
            <div className="flex w-1/2 h-full justify-start items-center">
                <form className="flex flex-col w-full gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-md" onSubmit={gerarNovoProduto}>
