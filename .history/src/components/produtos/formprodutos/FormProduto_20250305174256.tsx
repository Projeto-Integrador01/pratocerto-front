...
function FormProduto() {
    ...
    return (
        <div className="container flex flex-col mx-auto items-start w-full h-screen">
            {/* Container do formulário alinhado à esquerda e ocupando toda a largura e altura */}
            <div className="flex justify-start w-full h-full">
                <form className="flex flex-col w-full md:w-2/3 gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-md" onSubmit={gerarNovoProduto}>
