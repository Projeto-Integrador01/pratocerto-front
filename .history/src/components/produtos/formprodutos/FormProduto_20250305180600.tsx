...
function FormProduto() {
    ...
    return (
        <div className="w-full h-screen bg-white flex justify-center items-center">
            ...
            <form
                className={`flex flex-col w-full max-w-2xl gap-4 border-4 ${
                    id ? "border-blue-900" : "border-green-900"
                } bg-[#F2DAAC] p-6 rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.2),0_4px_20px_rgba(0,128,0,0.3)]`}
                onSubmit={gerarNovoProduto}
            >
                <h1
                    className={`text-2xl text-center my-4 ${
                        id ? "text-blue-900" : "text-green-900"
                    }`}
                >
