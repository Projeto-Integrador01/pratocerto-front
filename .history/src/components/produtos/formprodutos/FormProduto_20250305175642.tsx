...
function FormProduto() {
    ...
    return (
        <div className="w-full h-screen bg-green-900 flex justify-center items-center">
            {/* Formulário com o fundo claro #F2DAAC e sombra verde */}
            <form className="flex flex-col w-full max-w-2xl gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-[0_4px_10px_rgba(0,0,0,0.1),0_4px_20px_rgba(0,128,0,0.5)]" onSubmit={gerarNovoProduto}>
