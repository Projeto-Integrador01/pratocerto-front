...
function FormProduto() {
    ...
    return (
        <div className="w-full h-screen bg-white flex justify-center items-center">
          ...
          <form
            className="flex flex-col w-full h-full gap-4 bg-[#F2DAAC] p-6 rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.2),0_4px_20px_rgba(0,128,0,0.3)] relative"
            onSubmit={gerarNovoProduto}
          >
            {/* Botão invisível no canto superior direito */}
            <button
              type="button"
              onClick={voltarParaProdutos}
              className="absolute top-4 right-4 p-0 text-green-900 text-3xl bg-transparent border-none cursor-pointer"
            >
              <RiCloseCircleFill />
            </button>
