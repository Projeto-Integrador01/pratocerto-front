...
function FormProduto() {
    ...
    return (
        <div className="container flex flex-col mx-auto items-center">
            ...
            <form className="flex flex-col w-1/2 gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-md" onSubmit={gerarNovoProduto}>
                {/* Nome do Produto */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="nome" className="text-green-900 font-bold">Nome do Produto</label>
                    <input
                        type="text"
                        placeholder="Nome do Produto"
                        name="nome"
                        required
                        className="border-4 border-green-900 text-green-900 rounded p-2"
                        value={produto.nome}
                ...
                {/* Descrição */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="descricao" className="text-green-900 font-bold">Descrição do Produto</label>
                    <input
                        type="text"
                ...
                {/* Preço */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="preco" className="text-green-900 font-bold">Preço</label>
                    <input
                        type="number"
                        step="0.01"
                ...
                {/* Foto */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="foto" className="text-green-900 font-bold">Foto do Produto (URL)</label>
                    <input
                        type="text"
                ...
                {/* Tipo de Alimento */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="tipoAlimento" className="text-green-900 font-bold">Tipo de Alimento</label>
                    <select
                        name="tipoAlimento"
                        required
                        className="border-4 border-green-900 text-green-900 rounded p-2"
                ...
                {/* Categoria */}
                <div className="flex flex-col gap-2">
                    <label htmlFor="categorias" className="text-green-900 font-bold">Categoria do Produto</label>
                    <select
                        name="categoria"
                        id="categorias"
                        required
