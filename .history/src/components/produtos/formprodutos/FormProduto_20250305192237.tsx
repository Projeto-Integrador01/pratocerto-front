...
function FormProduto() {
    ...
    return (
        <div className="w-full h-screen bg-white flex justify-center items-center">
            ...
            <div className="    ">
                {/* Formulário com fundo claro #F2DAAC e sombra verde */}
                <form className="flex flex-col w-full h-full gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.2),0_4px_20px_rgba(0,128,0,0.3)]" onSubmit={gerarNovoProduto}>
                    <h1 className="text-2xl text-center my-4 text-green-900">
                        {id !== undefined ? 'Editar Produto' : 'Cadastrar Produto'}
                    </h1>
