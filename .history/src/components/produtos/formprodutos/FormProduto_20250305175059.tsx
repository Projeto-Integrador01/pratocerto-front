...
function FormProduto() {
    ...
    return (
        <div className="container flex flex-col mx-auto items-center w-full h-screen bg-green-900">
            {/* Formulário com o fundo claro #F2DAAC */}
            <form className="flex flex-col w-2/3 gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-md mt-12" onSubmit={gerarNovoProduto}>
