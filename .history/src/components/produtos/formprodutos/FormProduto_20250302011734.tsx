...
function FormProduto() {
    ...
    useEffect(() => {
        console.log("Produto atualizado:", produto); // Exibe o estado do produto quando ele é atualizado
    }, [produto]);
    ...
    function atualizarEstado(e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) {
        ...
        if (name === "preco") {
            let precoConvertido = parseFloat(value);
    
            // Evita que o preço seja 0 ou NaN
            if (precoConvertido <= 0 || isNaN(precoConvertido)) {
                precoConvertido = 1; // Define o valor mínimo como 1
            }
    
            setProduto({
                ...produto,
                [name]: precoConvertido,
            });
        } else {
            setProduto({
                ...produto,
