...
function FormProduto() {
    ...
    return (
        <div className="w-full h-screen bg-green-900 flex justify-center items-center">
            ...
            <form className="flex flex-col w-full max-w-2xl gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-lg shadow-green-800" onSubmit={gerarNovoProduto}>
