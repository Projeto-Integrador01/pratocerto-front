...
function FormProduto() {
    ...
    return (
        <div className="container flex flex-col mx-auto items-center">
            {/* Container do formulário alinhado à direita */}
            <div className="flex justify-end w-full">
                <form className="flex flex-col w-2/3 gap-4 border-4 border-green-900 bg-[#F2DAAC] p-6 rounded-lg shadow-md" onSubmit={gerarNovoProduto}>
