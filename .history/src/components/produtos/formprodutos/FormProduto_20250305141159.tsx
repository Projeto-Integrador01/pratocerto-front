...
interface FormProdutoProps {
    ...
    atualizarProdutos: Function;  // Passando a função de atualização
}

function FormProduto({ produtoId, atualizarProdutos }: FormProdutoProps) {
    ...
    async function enviarFormulario(e: ChangeEvent<HTMLFormElement>) {
        ...
        try {
            ...
            atualizarProdutos();  // Atualizando a lista de produtos após a ação
