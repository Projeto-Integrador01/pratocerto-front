...
function CardProdutos({ produto }: CardProdutosProps) {
  ...
  function retornar() {
    navigate('/produtos'); // Navega para a lista de produtos
  }
    ...
    <div className="border-slate-900 border flex flex-col rounded overflow-hidden justify-between">
      <div>
        ...
        <div className="p-4">
          ...
          {/* Exibe o nome do restaurante associado ao produto */}
          <p>Restaurante: {produto.restaurante?.nome}</p>
        </div>
      </div>

      {/* Somente o usuário (restaurante logado) pode deletar o produto */}
      {
